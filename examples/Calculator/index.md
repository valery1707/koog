...
In this mini-tutorial we’ll build a calculator agent powered by **Koog** tool-calling. You’ll learn how to:
...
We assume you’re in a Kotlin Notebook environment with Koog available. Provide an LLM executor
...
Tools are small, pure functions with clear contracts. We’ll use `Double` for better precision and format outputs consistently.
